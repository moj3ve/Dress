#import "DRSNotificationsSubPrefsListController.h"

@implementation DRSNotificationsSubPrefsListController
...
- (void)setEnabled {
    ...
    if ([[[self preferences] objectForKey:@"EnableNotificationsSection"] isEqual:@(YES)])
        [[self preferences] setBool:NO forKey:@"EnableNotificationsSection"];
    else
        [[self preferences] setBool:YES forKey:@"EnableNotificationsSection"];
