#import "DRSMediaPlayerSubPrefsListController.h"

@implementation DRSMediaPlayerSubPrefsListController
...
- (void)setEnabled {
    ...
    if ([[[self preferences] objectForKey:@"EnableMediaPlayerSection"] isEqual:@(YES)])
        [[self preferences] setBool:NO forKey:@"EnableMediaPlayerSection"];
    else
        [[self preferences] setBool:YES forKey:@"EnableMediaPlayerSection"];
