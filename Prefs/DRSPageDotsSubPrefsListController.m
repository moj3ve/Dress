#import "DRSPageDotsSubPrefsListController.h"

@implementation DRSPageDotsSubPrefsListController
...
- (void)setEnabled {
    ...
    if ([[[self preferences] objectForKey:@"EnablePageDotsSection"] isEqual:@(YES)])
        [[self preferences] setBool:NO forKey:@"EnablePageDotsSection"];
    else
        [[self preferences] setBool:YES forKey:@"EnablePageDotsSection"];
