...
- (void)setEnabled {
    ...
    if ([[[self preferences] objectForKey:@"EnableFaceIDLockSection"] isEqual:@(YES)])
        [[self preferences] setBool:NO forKey:@"EnableFaceIDLockSection"];
    else
        [[self preferences] setBool:YES forKey:@"EnableFaceIDLockSection"];
