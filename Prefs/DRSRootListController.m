...
- (void)viewDidLoad {
    ...
    [[self titleLabel] setText:@"2.5.10"];
    ...
    [[self iconView] setImage:[UIImage imageWithContentsOfFile:@"/Library/PreferenceBundles/DressPrefs.bundle/icon.png"]];
    ...
    [[self headerImageView] setImage:[UIImage imageWithContentsOfFile:@"/Library/PreferenceBundles/DressPrefs.bundle/Banner.png"]];
...
- (void)resetPreferences {
    ...
    [[NSFileManager defaultManager] removeItemAtPath:@"/var/mobile/Library/Preferences/love.litten.dress.colorspreferences.plist" error:nil];
