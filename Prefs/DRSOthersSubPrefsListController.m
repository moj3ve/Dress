...
- (void)setEnabled {
    ...
    if ([[[self preferences] objectForKey:@"EnableOthersSection"] isEqual:@(YES)])
        [[self preferences] setBool:NO forKey:@"EnableOthersSection"];
    else
        [[self preferences] setBool:YES forKey:@"EnableOthersSection"];
