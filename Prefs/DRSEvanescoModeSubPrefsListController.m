...
- (void)setEnabled {
    ...
    if ([[[self preferences] objectForKey:@"EnableEvanescoModeSection"] isEqual:@(YES)])
        [[self preferences] setBool:NO forKey:@"EnableEvanescoModeSection"];
    else
        [[self preferences] setBool:YES forKey:@"EnableEvanescoModeSection"];
