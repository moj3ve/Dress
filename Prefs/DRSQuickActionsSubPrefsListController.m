...
- (void)setEnabled {
    ...
    if ([[[self preferences] objectForKey:@"EnableQuickActionsSection"] isEqual:@(YES)])
        [[self preferences] setBool:NO forKey:@"EnableQuickActionsSection"];
    else
        [[self preferences] setBool:YES forKey:@"EnableQuickActionsSection"];
